...
2. In **Microsoft Edge** navigate to **https://compliance.microsoft.com** and log into the Microsoft 365 compliance portal as **MOD Administrator**.  
...
4. Click on the title **Mark 8 Project case** to open the case.
